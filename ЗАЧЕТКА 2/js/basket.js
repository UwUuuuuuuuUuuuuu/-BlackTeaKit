let itemBox = document.querySelectorAll(".item_box , .item_box2 , .item_box3 , .item_box4 , .item_box5 , .item_box6");
...
function openCart(e) {
  ...
  if (cartData !== null) {
    let cardTable = "";
    cardTable =
      '<table class="shopping_list"><tr><th>Название</th><th>Цена</th><th>Сколько</th><th>Убрать</th></tr>';
    ...
    cardTable += `<tr><td>Общая цена</td><td></td><td>${count()}</td><td></td></tr>`;
    cardTable += "<table>";
